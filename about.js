/* ==========================================================================
   M1 Radio — страница אודות («О нас»)
   Число каналов в текстах и статистике — динамическое (снимок 22,
   при загрузке обновляется из API станций).
   ========================================================================== */

const STATIONS_API = "https://live.positive-story.co.il/api/public/stations?type=radio";

// снимок: 21 канал (2026-07-09); главная — M1radio; служебная test не в счёт
const FALLBACK_COUNT = 21;

function setCount(n) {
  ["bandCount", "missionCount", "statStations"].forEach((id) => {
...
/* ---------- плеер: LIVE в шапке + CTA внизу (главный канал) ---------- */
...
document.getElementById("ctaPlay").addEventListener("click", playMain);
